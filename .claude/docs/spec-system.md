...
```
specs/app_spec.xml
    ↓  /init-from-spec (or bash .claude/scripts/init-from-app-spec.sh)
...
**Template**: `.claude/templates/app_spec_template.xml`
...
Every spec in `specs/features/` follows the template at `.claude/templates/feature_spec.md`:
...
This file is auto-generated by `.claude/scripts/init-from-app-spec.sh` and should be updated as features progress through the lifecycle.
