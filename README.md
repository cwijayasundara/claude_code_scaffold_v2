...
The implementer writes both code and tests in a single pass. The test-writer agent fills coverage gaps afterward if needed. See [docs/workflow.md](docs/workflow.md) for details.
